...
class ToolEnv:
    ...
    def step(self, action_text: str):
        ...
        if action == self.INVALID_ACTION:
            ...
            return result, self.PENALTY_FOR_INVALID, False, {"action_is_valid": False, "action_is_effective": False}
        ...
        if tool_name not in self.tool_map:
            ...
            return result, self.PENALTY_FOR_INVALID, False, {"action_is_valid": True, "action_is_effective": False}
        ...
        try:
            ...
            done = self.steps_taken >= self.max_turns
